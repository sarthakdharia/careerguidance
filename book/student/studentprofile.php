                ...
                <ul class="nav navbar-right top-nav">
                                ...
                                <a href="#">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <strong><?php echo $userRow['name']; ?> <?php echo $userRow['school']; ?></strong>
                                            </h5>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="studentupdateprofile.php?studentId=<?php echo $userRow['email']; ?>"><i class="fa fa-fw fa-user"></i> Update Profile</a>
                            </li>
                            <li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <a href="studentdashboard.php"><i class="fa fa-file"> Dashboard</a></i> 
                                </li>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
                                ...
                                <div class="panel panel-info">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><?php echo $userRow['name']; ?> <?php echo $userRow['school']; ?></h3>
                                    </div>
                                                ...
                                                <div class=" col-md-9 col-lg-9 ">
                                                    <table class="table table-user-information" align="center">
                                                        <tbody>
                                                            <tr>
                                                                <td>studentId:</td>
                                                                <td><?php echo $userRow['studentId']; ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td>name:</td>
                                                    ...
                                                    <input type="hidden" name="studentId" value="<?php echo $userRow['studentId']; ?>" />
