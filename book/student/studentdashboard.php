...
$res=mysql_query("SELECT * FROM student WHERE email=".$usersession);
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="studentprofile.php?userid=<?php echo $userRow['userid']; ?>"><i class="fa fa-fw fa-bar-chart-o"></i> Profile</a>
                        </li>
                        <li>
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <?php if ($userRow['studentMaritialStatus']=="") {
                        //<!-- / notification start -->
                        echo "<div class='row'>";
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <!-- table to display counselor schedule start -->
                                <div id="txtHint"><b> counselor schedule will be list here</b></div>
                                <!-- table to display counselor schedule end -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <h1><?php echo $userRow['userid']; ?><?php echo $userRow['password']; ?></h1>
