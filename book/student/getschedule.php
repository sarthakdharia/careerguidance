...
$q = $_GET['q'];
$res = mysqli_query($con,"SELECT * FROM counselorschedule WHERE scheduleDate='$q'");
if (!$res) {
...
<html lang="en">
    ...
    <body>
        ...
        echo "<div class='alert alert-danger' role='alert'>counsellor is not available at the moment. Please try again later.</div>";
        ...
        echo "   <table class='table table-hover'>";
            ...
            echo "  <tbody>";
                ...
                <tr>
                    ...
                    echo "<td><a href='confirmbook.php?&appid=" . $row['scheduleId'] . "&scheduleDate=".$q."' class='btn btn-".$btnclick." btn-xs' role='button' ".$btnstate.">Book Now</a></td>";
