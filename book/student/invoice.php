                ...
                <tr class="top">
                    <td colspan="2">
                        <table>
                            <tr>
                                <td class="title">
                                    <img src="assets/img/logoddd.png" style="width:100%; max-width:300px;">
                                </td>
                ...
                <tr class="information">
                    <td colspan="2">
                        <table>
                            <tr>
                                <td>
                                    <?php echo $userRow['studentAddress'];?>
                                </td>
                                
                                <td><?php echo $userRow['email'];?><br>
                                    <?php echo $userRow['name'];?> <?php echo $userRow['school'];?><br>
