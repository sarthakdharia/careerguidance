...
<html lang="en">
	...
	<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<ul class="nav navbar-nav">
							<li><a href="studentlogout.php?logout">Home</a></li>
							<!-- <li><a href="profile.php?studentId=<?php echo $userRow['email']; ?>" >Profile</a></li> -->
							<li><a href="studentapplist.php?studentId=<?php echo $userRow['email']; ?>">Contact Us</a></li>
						</ul>
					</ul>
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-md-8">
							...
							<!-- notification end -->
							<h1>Hi User. Make appointment today!</h1>
		...
		<div class="copyright-bar bg-black">
			<div class="container">
				<p class="pull-left small">Career Guidance System</p>
