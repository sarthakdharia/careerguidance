...
{
$_SESSION['studentSession'] = $row['email'];
?>
...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p>This is counsellor's Schedule. Please <span class="label label-danger">login</span> to make an appointment. </p>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">Before taking the appoinment, give our exam <a href ="quizindex.php">quiz link</a></p>
