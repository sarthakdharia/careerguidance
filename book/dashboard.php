    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home.php"><b>Online Quiz System</b></a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dashboard.php?q=2">Preferences</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==0)
                {
                   ...
                   echo'<h2><center>Profile</center></h2>';
                   echo  '<div class="panel title"><div class="table-responsive">
                    <table class="table table-striped title1" >
                    <tr style="color:red"><td><center><b>Sr No.</b></center></td><td><center><b>Email</b></center></td><td><center><b>Password</b></center></td></tr>
                    <tr style="color:black"><td><center><b>1)</b></center></td><td><center><b>aditid2701@gmail.com</b></center></td><td><center><b>.....</b></center></td></tr>';
                ...
                <?php 
                    if(@$_GET['q']==1) 
                    {
                        ...
                        while($row = mysqli_fetch_array($result)) 
                        {
                            ...
                            $email = $row['email'];
                            $school = $row['school'];
                            echo '<tr><td><center>'.$c++.'</center></td><td><center>'.$name.'</center></td><td><center>'.$school.'</center></td><td><center>'.$email.'</center></td><td><center><a title="Delete student" href="quizupdate.php?demail='.$email.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></center></td></tr>';
                        }
                        $c=0;
                        echo '</table></div></div>';
                    }
                        ...
                        <form class="form-horizontal title1" name="form" action="quizupdate.php?q=addquiz"  method="POST">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="right" name="right" placeholder="Enter marks on yes" class="form-control input-md" min="0" type="number">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="No" name="No" placeholder="Enter minus marks on no without sign" class="form-control input-md" min="0" type="number">
                                    </div>
                                </div>
                ...
                <?php 
                    if(@$_GET['q']==5) 
                    {
                        ...
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            $Yes = $row['Yes'];
                            $eid = $row['eid'];
                            echo '<tr><td><center>'.$c++.'</center></td><td><center>'.$title.'</center></td><td><center>'.$total.'</center></td><td><center>'.$Yes*$total.'</center></td>
